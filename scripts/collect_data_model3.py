...
for setting in data_settings['dataParams']:
    ...
    hyp_opt_script_path = os.path.join(os.path.dirname(__file__), '../hyperparameter_optimization/model3.py')
    ...
    compare_methods_script_path = os.path.join(os.path.dirname(__file__), '../compare_methods/model3.py')
